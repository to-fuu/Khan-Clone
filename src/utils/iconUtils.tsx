...
// Function to get icon for lesson type
export const getLessonTypeIcon = (type: string): JSX.Element => {
  switch (type) {
    case 'video':
      return (
    ...
    case 'quiz':
      return (
        <svg className="w-4 h-4 text-purple-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
